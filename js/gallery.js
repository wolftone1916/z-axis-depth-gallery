        ...
        this.cards.forEach(card => {
            ...
            Draggable.create(card, {
                ...
                onDragStart: function() {
                    // Get the card's bounding rect for accurate positioning
                    const rect = card.getBoundingClientRect();
                    
                    // Calculate offset: where on the card did the mouse grab it
                    offsetX = this.pointerX - rect.left;
                    offsetY = this.pointerY - rect.top;
                ...
                onDrag: function() {
                    // Position card so mouse is at the grab point
                    const newLeft = this.pointerX - offsetX;
                    const newTop = this.pointerY - offsetY;
                ...
                onDragEnd: (e) => {
                    ...
                    if (rect.top < threshold) {
                        ...
                        const initialState = this.cardStates[this.cards.indexOf(card)];
                        gsap.to(card, {
